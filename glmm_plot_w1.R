setwd("c:/Users/USER/Documents/jeewon")
library(ggplot2)

## DV: rmse
dat.rmse <- read.delim("c:/Users/USER/Documents/jeewon/glmm_bias.txt")
...
ggplot(data=dat.rmse, 
  ...
  ylim(0,0.5)+
  labs(x="Beta0", shape="Beta1") 


##### DV: Type 1 error rate
dat.type1error <- read.delim("c:/Users/USER/Documents/jeewon/glmm_type1error.txt")
...
dat.power <- read.delim("c:/Users/USER/Documents/jeewon/glmm_power.txt")
